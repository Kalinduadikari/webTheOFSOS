...
import { fetchForecastDemandTuna, selectForecastTuna, selectIsLoading, selectError } from '../../redux/features/mlmodel/mlModelSlice';
...
const ForecastDemandTuna = () => {
    const dispatch = useDispatch();
    const forecast = useSelector(selectForecastTuna); 
    const isLoading = useSelector(selectIsLoading);
    const error = useSelector(selectError);


    useEffect(() => {
        dispatch(fetchForecastDemandTuna());
    }, [dispatch]);
...
export default ForecastDemandTuna;